...
| `accountRefreshInterval` | Here set the background MELCLoud account settings refresh time in (sec), default 120. |
...
| `ataRefreshInterval` | Here set the background ATA device state refresh time in (sec), default 75. |
...
| `atwRefreshInterval` | Here set the background ATW device state refresh time in (sec), default 75. |
...
| `ervRefreshInterval` | Here set the background ERV device state refresh time in (sec), default 75. |
